...
var calcRectArea = function()
{
    ...
    alert ("The Rectangle area is " + rectArea(floatHeight, floatWidth));
};

function rectArea(floatHeight_par, floatWidth_par)
{
    var floatArea = parseFloat(floatHeight_par * floatWidth_par);
    return floatArea.toFixed(2);
}
...
var calcRectPerim = function()
{
    ...
    alert ("The Rectangle perimeter is " + rectPerim(floatHeight, floatWidth));
};

function rectPerim(floatHeight_par, floatWidth_par)
{
    var floatPerim = parseFloat(2 * floatWidth_par + 2 * floatHeight_par);
...
{
    var floatPerim = parseFloat (floatTriSide1 + floatTriSide2 + floatTriSide3);
    return floatPerim.toFixed(2);
}
...
//    $("radius").value = "";
    ...
    $("calc_tri_perim").onclick = calcTriangleArea;
